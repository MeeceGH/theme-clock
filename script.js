...
btnEl.addEventListener('click', () => {
    ...
    btnEl.classList.toggle('dark-mode-btn');
    minuteEl.classList.toggle('dark-mode-hand');
    hourEl.classList.toggle('dark-mode-hand');
    circle.classList.toggle('dark-mode-circle');
